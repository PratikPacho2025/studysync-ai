...
import { timetableDays } from '../../data/mock/timetable'
...
export function TimetablePage() {
  ...
  function loadTimetable() {
    api.fetchTimetable().then(setLectures).catch(console.error)
  }
  ...
  function handleUploadTimetable(file) {
    setIsUploading(true)
    api.uploadTimetable(file)
      .then((data) => {
        loadTimetable()
        alert('Timetable successfully scanned and added to calendar automatically!')
      })
      .catch((err) => {
        console.error(err)
        alert(err.message || 'Failed to scan timetable')
      })
      .finally(() => {
  ...
  const addLecture = (lecture) => { 
    api.createLecture(lecture).then(() => {
      loadTimetable()
